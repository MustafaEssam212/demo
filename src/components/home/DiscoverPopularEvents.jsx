    ...
    return(
        <div className="discover-popular-event-container">
            ...
            <div className="discover-popular-event-tabs">
                <Tabs additionalClassNames="discover-popular-event-additional" width={65} tabs={['Exhibitor', 'Vendor', 'Tickets', 'Sponsor', 'Kids Activity', 'Marketplace']} active={0} sendDataToParent={getDataFromChild} />
            </div>
